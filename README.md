...
## アプリケーション作成背景
趣味のダンスができる場所を探したいときはレンタルスペースの検索サイトを利用していたのですが、それではダンスができる全ての場所を検索することができず、近くに非常に良い施設があることを知らずに過ごしていました。そういった背景があり、踊れる場所の検索に特化したサービスがあれば便利だと考えこのアプリケーションを作成しました。
